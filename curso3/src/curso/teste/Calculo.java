...
// Impressão percorrendo a lista
			...
			b.append("\n A linha do erro é a: "+e.getStackTrace()[i].getLineNumber());
			b.append("\n Do método: "+e.getStackTrace()[i].getMethodName());
			b.append("\n Da classe: "+e.getStackTrace()[i].getClassName());
			
			JOptionPane.showMessageDialog(null, b.toString());
			e.printStackTrace();
			}
		} finally {
			JOptionPane.showMessageDialog(null, "Um XERO!");
		}
	}
}