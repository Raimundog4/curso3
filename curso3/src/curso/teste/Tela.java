...
//				for (Fruta frutas : mercado.getFrutas()) {
					System.out.println("O nome da fruta é: "+fruta.getNome());
					System.out.println("A cor da fruta é: "+fruta.getCor());
					System.out.println("A o estoque inicial: "+fruta.getQuantidade());
					System.out.println("A validade da fruta é: "+fruta.getValidade());
					System.out.println("Quantidade de frutas compradas: "+fruta.getCompras());
					System.out.println("Quantidade de frutas vendidas: "+fruta.getVendas());
					System.out.println("O estoque final: "+saldo);
//				}
			}
		});
